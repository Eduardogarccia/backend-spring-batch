...
public class CnabService {
	...
	public CnabService(@Value("${file.upload-diretorio}") String fileUploadDiretorio, @Qualifier("jobLauncherAsync") JobLauncher jobLauncher, Job job) {
		this.fileStorageLocation = Paths.get(fileUploadDiretorio);
